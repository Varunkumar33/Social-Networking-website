...
<html>
    ...
    <body>
        ...
        <div class = "row">
            <div class = "col-sm-2" style = "background-color: #e6e6e6; text-align: center; left: 0%;
            border-radius: 5px;">
                <?php
                    echo "
            ...
            <div class="col-sm-6">
                ...
                while ($row_posts = mysqli_fetch_array($run_posts)) {
                    ...
                    if($content == "No" && strlen($upload_image) >= 1){
                        ...
                        echo "
                            <div id='own_posts' style = 'margin-left:10px;'>
                                <div class='row'>
                                    <div class='col-sm-2'>
                                    <p><img src='users/$user_image' class='img-circle' width='100px' height='100px'></p>    
                                    </div>
                        ...
                        if($u_email != $user_email){
                            ...
                            echo "
                            <br>
                            <a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-success'style ='margin-left:10px;'>
                            <i class = 'fa fa-eye' style = 'margin-right:4px;'></i>View</button></a>

                            <a href='edit_post.php?post_id=$post_id'  style='float:right;'><button class='btn btn-info' style = 'margin-left:10px;'>
                            <i class = 'fa fa-pencil' style = 'margin-right:4px;'></i>Edit</button></a>

                            <a href='functions/delete_post.php?post_id=$post_id'  style='float:right;'><button class='btn btn-danger'>
                            <i class = 'fa fa-trash' style = 'margin-right:4px;'></i>Delete</button></a>
                            <br>
                            </div><br><br>
                            ";
                        }
