    ...
    <body>
        <div class= "row">
           <?php
            ...
            $run_user=mysqli_query($con, $get_user);
            $rowr=mysqli_fetch_array($run_user);

            $user_from_msg = $rowr['user_id'];
            $user_from_name=$rowr['user_name'];
           ?>
                    ...
                    while($row_user = mysqli_fetch_array($run_user)){
                        ...
                        echo "
                            <div class='container-fluid'>
                                ...
                                <img src='users/$user_image' class='img-circle' width='90px' height='80px' title='$user_name'> <strong>&nbsp $first_name $last_name</strong>
                                </a>
                            </div>
                        ";
                    }
           ...
           <div class="col-sm-6">
                    <div class="load_msg" id="scroll_messages">
                        ...
                        <div id="loaded_msg">
                                    ...
                                    else if($user_to == $user_from_msg AND $user_from == $user_to_msg){ echo "<div class='messgae' id='green' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";} ?></p>
                        </div>
                ...
                <?php
                    if(isset($_GET['u_id'])){
                        ...
                        if($u_id == "new"){
                            echo '
                            <form>
                                <center><h3>Select someone to start conersation</h3></center>
                ...
                <?php
                    if(isset($_POST['send_msg'])){
                        ...
                        if($msg == ""){
                            echo "<h4 style='color:red; text-aling: center;'>Message was unable to send!</h4>";
                        }else if(strlen($msg)>37){
                            echo "<h4 style='color:red; text-aling: center;'>Message is too long! USe only 37 characters</h4>";
                        }else{
                    ...
                    if($get_id == "new"){
                        ...
                        echo "
                            <div class='row'>
                                ...
                                <img src='users/$user_image' class='img-circle' width='150' height='150'>
                                <br><br>
                                <ul class='list-group'>
