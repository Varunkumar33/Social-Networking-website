<?php
    ...
    if(isset($_POST['sign_up'])){
        ...
        $rand= rand(1,3); //random number between 1 and 3
            ...
            if($rand == 1 )
                $profile_pic = "head_red.jfif";
            else if($rand == 2 )
                $profile_pic = "head_blue.png";
            else if($rand == 3 )
                $profile_pic = "head_pink.png";

        $insert = "INSERT INTO `users` (`f_name`, `l_name`, `user_name`, `describe_user`, `Relationship`, `user_pass`, `user_email`,  `user_country`, `user_gender`, `user_birthday`, `user_image`, `user_cover`, `user_reg_date`, `status`, `posts`, `recovery_account`) VALUES ('$first_name', '$last_name', '$username','Hello Instabook. This is my default status!', '....', '$pass', '$email', '$country', '$gender', '$birthday', '$profile_pic', 'default_cover.jpg', current_timestamp(),'$status', '$posts', 'Iwanttoputadingintheuniverse.')";
